...
## @return: datasource0
## @inputs: []
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "productsdb", table_name = "products", transformation_ctx = "datasource0")
## @type: ApplyMapping
...
datasink4 = glueContext.write_dynamic_frame.from_jdbc_conf(frame = dropnullfields3, catalog_connection = "glueConnect", connection_options = {"dbtable": "products", "database": "products"}, transformation_ctx = "datasink4")
job.commit()
